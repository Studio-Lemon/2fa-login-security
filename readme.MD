...
[![Latest Stable Version](https://poser.pugx.org/studio-lemon/2fa-login-security/v/stable)](https://packagist.org/packages/studio-lemon/2fa-login-security)

2FA Login Security is a standalone WordPress plugin focused on two-factor authentication. It is a fork of the discontinued [Wordfence Login Security](https://wordpress.org/plugins/wordfence-login-security/) plugin and is being pared down into a smaller plugin with fewer moving parts.
...
Install the plugin from [Packagist](https://packagist.org/packages/studio-lemon/2fa-login-security) in your WordPress project's root directory:

```bash
composer require studio-lemon/2fa-login-security
```

Configure your project with [Composer Installers](https://github.com/composer/installers) so packages of type `wordpress-plugin` are placed in your WordPress plugins directory:
