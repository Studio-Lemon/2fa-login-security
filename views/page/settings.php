...
<form method="post" action="<?php echo esc_url(self_admin_url('admin-post.php')); ?>">
	...
	<div id="wfls-settings" class="wfls-flex-row wfls-flex-row-wrappable wfls-flex-row-equal-heights">
		...
		<div id="wfls-user-stats" class="wfls-flex-row wfls-flex-row-equal-heights wfls-flex-item-xs-100">
			<?php
			echo \TFAuthLS\Model_View::create('settings/user-stats', array(
			...
			<table class="form-table" role="presentation">
				<tbody>
					...
					<tr>
						...
						<td><label><input type="checkbox" name="wfls_settings[stack-ui-columns]" value="1" <?php checked($settings->get_bool(\TFAuthLS\Controller_Settings::OPTION_STACK_UI_COLUMNS, true)); ?>> <?php esc_html_e('Use stacked layout on narrow screens', '2fa-login-security'); ?></label></td>
					</tr>
					<tr>
